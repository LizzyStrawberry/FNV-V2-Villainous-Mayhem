function onCreatePost()
	...
	if getPropertyFromClass('ClientPrefs', 'optimizationMode') == true then
		...
		if songName == 'Scrouge' then
			removeLuaScript('mods/data/scrouge/small script');
		...
		if songName == 'Forsaken' then
			...
			removeLuaScript('mods/data/forsaken/Instructions Script');
		...
		if songName == 'Lustality Remix' then
			removeLuaScript('mods/data/lustality-remix/Small thingies');
		...
		if songName == 'Libidinousness' then
			...
			removeLuaScript('mods/data/libidinousness/Instructions Script');
		...
		if songName == 'Cheap Skate (Legacy)' then
			removeLuaScript('mods/data/cheap-skate-(legacy)/small script');
		...
		if songName == 'Sussus Marcus' then
			...
			removeLuaScript('mods/data/sussus-marcus/Instructions Script');
		...
		if songName == 'Spendthrift' then
			removeLuaScript('mods/data/spendthrift/small script');
		...
		if songName == "Get Villain'd" then
			...
			removeLuaScript('mods/data/get-villaind/CinematicBars');
		end
		...
		if songName == 'Unpaid Catastrophe' then
			...
			removeLuaScript('mods/data/unpaid-catastrophe/nstructions Script');
		end
		...
		if songName == 'Lustality' then
			removeLuaScript('mods/data/lustality/Small thingies');
		...
		if songName == 'Lustality V1' then
			...
			removeLuaScript('mods/data/lustality-v1/Small thingies');
		...
		if songName == 'Tofu' then
			removeLuaScript('mods/data/tofu/small script again');
		...
		if songName == 'Fast Food Therapy' then
			...
			removeLuaScript('mods/data/fast-food-therapy/Death');
		end
