...
function onUpdate()
	if curBeat == 64 then
		noteTweenY('GFNote1', 4, notePos[1] + 900, 12, 'cubeInOut')
		noteTweenY('GFNote2', 6, notePos[2] + 900, 12.6, 'cubeInOut')
		noteTweenY('GFNote3', 7, notePos[3] + 900, 13.2, 'cubeInOut')
		
		noteTweenAngle('GFNoteAngle1', 4, -10, 7, 'cubeInOut')
		noteTweenAngle('GFNoteAngle2', 6, 10, 7.6, 'cubeInOut')
		noteTweenAngle('GFNoteAngle3', 7, 15, 8.2, 'cubeInOut')
	end
	
	if curBeat == 80 then
		doTweenAngle('camAngle', 'camGame', 15, 24, 'cubeInOut')
		doTweenAngle('camAngleHUD', 'camHUD', 15, 24, 'cubeInOut')
		
		doTweenZoom('camGame', 'camGame', 1.4, 24, 'cubeInOut')
		
		noteTweenDirection('GFDirectionChange', 5, 450 * 100, 24, 'cubeInOut')
		noteTweenAngle('GFAngleChange', 5, 450 * 100, 24, 'cubeInOut')
		
		doTweenColor('whiteBG', 'whiteBG', '820101', 25, 'cubeInOut')
	end
	
	if curBeat == 140 then
		doTweenAngle('camAngle', 'camGame', 0, 0.6, 'cubeInOut')
		doTweenAngle('camAngleHUD', 'camHUD', 0, 0.6, 'cubeInOut')
		noteTweenY('GFNote1', 4, notePos[1], 1, 'cubeInOut')
		noteTweenY('GFNote2', 6, notePos[2], 1, 'cubeInOut')
		noteTweenY('GFNote3', 7, notePos[3], 1, 'cubeInOut')
	end
...
function onTweenCompleted(tag)
	if tag == 'GFNoteAngle2' then
		...
		noteTweenAngle('GFNoteAngleFix2', 6, 0, 1, 'cubeInOut')
