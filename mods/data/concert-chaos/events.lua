...
function onUpdatePost()
		...
		if curBeat % 16 == 4 then
			if mustHitSection then
				...
				if curStep >= 848 and curStep < 1359 then
					...
					setProperty('gf.x', getProperty('boyfriend.x') - 120)
					setProperty('gf.y', getProperty('boyfriend.y') + 40)
				end
			else
				setProperty('boyfriend.alpha', 0)
				setProperty('dad.alpha', 1)
				...
				if curStep >= 848 and curStep < 1359 then
					...
					setProperty('gf.y', getProperty('dad.y') + 40)
				end
			end
		end
	end
	...
	if curStep == 848 then
		...
		setProperty('gf.x', getProperty('dad.x') + 20)
		setProperty('gf.y', getProperty('dad.y') - 30)
