...
class PulseEffect extends Effect
{
	...
	public var waveFrequency(default, set):Float = 0;
	public var waveAmplitude(default, set):Float = 0;
	public var waveMultiplier(default, set):Float = 0;

	public function new(waveMultiplier:Float,waveSpeed:Float,waveFrequency:Float,waveAmplitude:Float):Void
	{
		this.waveSpeed = waveSpeed;
		this.waveFrequency = waveFrequency;
		this.waveAmplitude = waveAmplitude;
	...
	function set_waveMultiplier(v:Float):Float
	{
		waveMultiplier = v;
		shader.uampmul.value = [waveMultiplier];
		return v;
	}
