...
class MobileData {
	...
	public static function setButtonsColors(buttonsInstance:Dynamic):Dynamic {
		...
		buttonsInstance.buttonLeft.color = ClientPrefs.padRGB[0][0];
		buttonsInstance.buttonDown.color = ClientPrefs.padRGB[1][0];
		buttonsInstance.buttonUp.color = ClientPrefs.padRGB[2][0];
		buttonsInstance.buttonRight.color = ClientPrefs.padRGB[3][0];
