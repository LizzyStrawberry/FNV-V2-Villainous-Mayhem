...
class Controls extends FlxActionSet
{
	...
	var _mayhem = new FlxActionDigital(Action.MAYHEM);
	var _charm1 = new FlxActionDigital(Action.CHARM1);
	var _charm2 = new FlxActionDigital(Action.CHARM2);
	var _charm3 = new FlxActionDigital(Action.CHARM3);
	...
	inline function get_BACK()
		return _back.check() || hitboxJustPressed(MobileInputID.B) #if android || FlxG.android.justReleased.BACK #end;
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			...
			case MAYHEM:
				func(_mayhem, JUST_PRESSED);
			case CHARM1:
				func(_charm1, JUST_PRESSED);
			case CHARM2:
				func(_charm2, JUST_PRESSED);
			case CHARM3:
				func(_charm3, JUST_PRESSED);
			case BACK:
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.MAYHEM, keysMap.get('mayhem'));
				inline bindKeys(Control.CHARM1, keysMap.get('charm1'));
				inline bindKeys(Control.CHARM2, keysMap.get('charm2'));
				inline bindKeys(Control.CHARM3, keysMap.get('charm3'));
			...
			case Duo(true):
				...
				inline bindKeys(Control.ATTACK, [SHIFT]);
				inline bindKeys(Control.MAYHEM, [ALT]);
				inline bindKeys(Control.CHARM1, [ONE]);
