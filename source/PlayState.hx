...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Cockwombler', 0.4], //From 20% to 39%
		['Skill Issue', 0.5], //From 40% to 49%
		['The Hell?', 0.6], //From 50% to 59%
		['Average.', 0.69], //From 60% to 68%
		['Funni..', 0.7], //69%
		['Good Enough!', 0.8], //From 70% to 79%
		['Pro Fingers!', 0.9], //From 80% to 89%
		['Wahoohie!', 1], //From 90% to 99%
		['Go Outside!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	//For Results screen for Freeplay
	public static var freeplayScore:Int = 0;
	public static var freeplayMisses:Int = 0;

	public static var isIniquitousMode:Bool = false;

	public static var isInjectionMode:Bool = false;
	public static var injectionPlaylist:Array<String> = [];
	public static var injectionDifficulty:Int = 1;
	public static var injectionHealth:Float = 1;
	public static var injectionRating:Float = 0;
	public static var injectionSongsPlayed:Int = 0;
	public static var injectionPlaylistTotal:Int = 0;
	public static var injectionScore:Int = 0;
	public static var injectionMisses:Int = 0;
	public static var injectionBestCombo:Int = 0;

	public static var isMayhemMode:Bool = false;
	public static var mayhemPlaylist:Array<String> = [];
	public static var mayhemReplaylist:Array<String> = [];
	public static var mayhemDifficulty:Int = -1;
	public static var mayhemHealth:Float = 1;
	public static var mayhemRating:Float = 0;
	public static var mayhemSongsPlayed:Int = 0;
	public static var mayhemScore:Int = 0;
	public static var mayhemBestCombo:Int = 0;
	public static var mayhemTotalChallenges:Int = 0;

	public static var mayhemNRMode:String = '';
	...
	public static var healthCheck:Float = 1;
	...
	public static var timeTxtPause:FlxText;
	...
	//For Attacking
	public static var choseAttack:Bool = false;

	//For Reloading + Narrin's death
	public static var reloadingGun:Bool = false;
	...
	override public function create()
	{
		...
		else if (isInjectionMode)
		{
			detailsText = "Injection Mode";
		}
		...
		if (isInjectionMode)
		{
			...
			healthCheck = injectionHealth;
		}

		//For Mayhem Mode
		if (isMayhemMode == true)
		{
			health = mayhemHealth;
		...
		//For Results screen
		if (isStoryMode)
			ClientPrefs.campaignHighScore = Highscore.getWeekScore(WeekData.getWeekFileName(), storyDifficulty);
		else
			ClientPrefs.campaignHighScore = Highscore.getScore(songName, storyDifficulty);
		...
		if (!stageData.hide_girlfriend || gfVersion == 'noGF')
		{
		...
		timeTxtPause = new FlxText(STRUM_X + (FlxG.width / 2) - 248, 19, 400, "", 32);
		timeTxtPause.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		timeTxtPause.scrollFactor.set();
		timeTxtPause.alpha = 0;
		timeTxtPause.borderSize = 2;
		timeTxtPause.visible = showTime;
  	...
  	public function clearShaderFromCamera(cam:String)
	{
		...
		switch(cam.toLowerCase())
		{
			...
			default:
				if(modchartSprites.exists(cam))
					Reflect.setProperty(modchartSprites.get(cam), "shader", []);
				else if(modchartTexts.exists(cam))
					Reflect.setProperty(modchartTexts.get(cam), "shader", []);
				else
				{
					var OBJ = Reflect.getProperty(PlayState.instance,cam);
					Reflect.setProperty(OBJ,"shader", []);
				}	
		}
  }
	...
	public function startCountdown():Void
	{
				...
				if(curStage == 'mall') {
					...
					switch (swagCounter)
					{
						case 0:
							if(Paths.formatToSongPath(SONG.song) == 'lustality' || Paths.formatToSongPath(SONG.song) == 'lustality-v1' || Paths.formatToSongPath(SONG.song) == 'lustality-remix')
							{
								FlxG.sound.play(Paths.sound('intro3Kiana' + introSoundsSuffix), 0.6);
							}
						case 1:
							...
							if(Paths.formatToSongPath(SONG.song) == 'lustality' || Paths.formatToSongPath(SONG.song) == 'lustality-v1' || Paths.formatToSongPath(SONG.song) == 'lustality-remix')
							{
								FlxG.sound.play(Paths.sound('intro2Kiana' + introSoundsSuffix), 0.6);
							}
							else
							{
						...
						case 2:
							...
							if(Paths.formatToSongPath(SONG.song) == 'lustality' || Paths.formatToSongPath(SONG.song) == 'lustality-v1' || Paths.formatToSongPath(SONG.song) == 'lustality-remix')
							{
								FlxG.sound.play(Paths.sound('intro1Kiana' + introSoundsSuffix), 0.6);
							}
							else
							{
						...
						case 3:
							...
							if(Paths.formatToSongPath(SONG.song) == 'lustality' || Paths.formatToSongPath(SONG.song) == 'lustality-v1' || Paths.formatToSongPath(SONG.song) == 'lustality-remix')
							{
								FlxG.sound.play(Paths.sound('introGoKiana' + introSoundsSuffix), 0.6);
							}
							else
							{
		...
		else if (countdownNumber == 1)
		{
			...
			if (voiceNumber == 4 || voiceNumber == 5)
				new FlxTimer().start(0.1 / playbackRate, function (tmr:FlxTimer) {
					FlxG.sound.play(Paths.sound('normalintros/' + voiceNumber + '/intro3' + introSoundsSuffix), 0.6);
				});
			...
			new FlxTimer().start(0.80 / playbackRate, function (tmr:FlxTimer) {
				...
				countdownReady.antialiasing = antialias;
					...
					FlxG.sound.play(Paths.sound('normalintros/' + voiceNumber + '/intro2' + introSoundsSuffix), 0.6);
			...
			new FlxTimer().start(1.60 / playbackRate, function (tmr:FlxTimer) {
				...
				countdownSet.antialiasing = antialias;
					...
					FlxG.sound.play(Paths.sound('normalintros/' + voiceNumber + '/intro1' + introSoundsSuffix), 0.6);
				if ((Paths.formatToSongPath(SONG.song) == 'point-blank'))
			...
			new FlxTimer().start(2.40 / playbackRate, function (tmr:FlxTimer) {
				...
				if ((Paths.formatToSongPath(SONG.song) == 'point-blank'))
					...
					FlxG.sound.play(Paths.sound('normalintros/' + voiceNumber + '/introGo' + introSoundsSuffix), 0.6);
			});
		...
		{			
			...
			introAssets.set('pixel', ['pixelUI/ready-pixel', 'pixelUI/set-pixel', 'pixelUI/date-pixel']);
				...
				var antialias:Bool = ClientPrefs.globalAntialiasing;
			new FlxTimer().start(0.1 / playbackRate, function (tmr:FlxTimer) {
				FlxG.sound.play(Paths.sound('cupintros/' + voiceNumber), 0.6);
	...
	{
		if (isInjectionMode)
			scoreTxt.text = 'Score: ' + (campaignScore + songScore)
			+ ' | Misses: ' + songMisses
			+ ' | Rating: ' + ratingName
	...
	override public function update(elapsed:Float)
	{
		...
		var mult:Float = FlxMath.lerp(0.7, iconP1.scale.x, CoolUtil.boundTo(1 - (elapsed * 9 * playbackRate), 0, 1));
		if (ClientPrefs.optimizationMode == true)
			mult = FlxMath.lerp(1, iconP1.scale.x, CoolUtil.boundTo(1 - (elapsed * 9 * playbackRate), 0, 1));
		iconP1.scale.set(mult, mult);
		iconP1.updateHitbox();

		var mult:Float = FlxMath.lerp(0.7, iconP2.scale.x, CoolUtil.boundTo(1 - (elapsed * 9 * playbackRate), 0, 1));
		if (ClientPrefs.optimizationMode == true)
			mult = FlxMath.lerp(1, iconP2.scale.x, CoolUtil.boundTo(1 - (elapsed * 9 * playbackRate), 0, 1));
		...
		else
		{
			if (!paused)
			{
				...
				if(updateTime) {
					...
					timeTxtPause.text = FlxStringUtil.formatTime(secondsTotal, false);
				}
			}
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'Add Camera Zoom':
				...
				else if(ClientPrefs.camZooms && FlxG.camera.zoom < 1.35) {
					var camZoom:Float = Std.parseFloat(value1);
					var hudZoom:Float = Std.parseFloat(value2);
					if(Math.isNaN(camZoom)) camZoom = 0.015;
					if(Math.isNaN(hudZoom)) hudZoom = 0.03;
	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			'WeekKiana_Beaten', 'WeekKianaVillainous_Beaten', 'WeekKianaIniquitous_Beaten',
			'WeekMorky_Beaten', 'WeekMorkyVillainous_Beaten',
			'WeekSus_Beaten', 'WeekSusVillainous_Beaten',
		...
		if(ret != FunkinLua.Function_Stop && !transitioning) {
			...
			if (isStoryMode)
			{
				...
				ClientPrefs.campaignSongsPlayed += 1;
			...
			{
				injectionHealth = health;
				campaignScore += songScore;
				campaignMisses += songMisses;
				injectionScore += songScore;
				injectionMisses += songMisses;
				injectionRating += ratingPercent;
				injectionSongsPlayed += 1;

				injectionPlaylist.remove(injectionPlaylist[0]);
			...
			else if (isMayhemMode)
			{
				...
				var difficulty:String = CoolUtil.getDifficultyFilePath(FlxG.random.int(0, 1));
			...
			else
			{
				...
				trace('Saved High Score for Song: ' + ClientPrefs.campaignHighScore);
				trace('Saved Rating for the Song: ' + ClientPrefs.campaignRating);
				trace('Saved Best Combo for the Song: ' + ClientPrefs.campaignBestCombo);
				trace('Saved Songs Played: ' + ClientPrefs.campaignSongsPlayed);
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		if (ClientPrefs.missRelatedCombos == true)
			if (songMisses < 1)
				...
				{
					rating.loadGraphic(Paths.image(pixelShitPart1 + daRating.image + '_CustomFC' + pixelShitPart2));
				}	
				else
				{
					rating.loadGraphic(Paths.image(pixelShitPart1 + daRating.image + '_FC' + pixelShitPart2));
				}	
			else if (songMisses >= 1 && songMisses <= 9)
				if (ClientPrefs.customRating == 'FNV')
				{
					rating.loadGraphic(Paths.image(pixelShitPart1 + daRating.image + '_CustomSDCB' + pixelShitPart2));
				}
				else
				{
					rating.loadGraphic(Paths.image(pixelShitPart1 + daRating.image + '_SDCB' + pixelShitPart2));
				}
			else
				if (ClientPrefs.customRating == 'FNV')
				{
					rating.loadGraphic(Paths.image(pixelShitPart1 + daRating.image + '_CustomNormal' + pixelShitPart2));
				}
				else
				{
		...
		if (ClientPrefs.comboPosition == 'Hud')
		...
		for (i in seperatedScore)
		{
			...
			if (ClientPrefs.missRelatedCombos == true)
				if (songMisses < 1)
					if (ClientPrefs.customRating == 'FNV')
					{
						numScore.loadGraphic(Paths.image(pixelShitPart1 + 'num' + Std.int(i) + '_CustomFC' + pixelShitPart2));
					}
					else
					{
						numScore.loadGraphic(Paths.image(pixelShitPart1 + 'num' + Std.int(i) + '_FC' + pixelShitPart2));
					}
					
				else if (songMisses >=1 && songMisses <= 9)
					if (ClientPrefs.customRating == 'FNV')
						{
							numScore.loadGraphic(Paths.image(pixelShitPart1 + 'num' + Std.int(i) + '_CustomSDCB' + pixelShitPart2));
						}
						else
						{
							numScore.loadGraphic(Paths.image(pixelShitPart1 + 'num' + Std.int(i) + '_SDCB' + pixelShitPart2));
						}
				else
					if (ClientPrefs.customRating == 'FNV')
						{
							numScore.loadGraphic(Paths.image(pixelShitPart1 + 'num' + Std.int(i) + '_CustomNormal' + pixelShitPart2));
						}
						else
						{
	...
	function noteMiss(daNote:Note):Void { //You didn't hit the key and let it go offscreen, also used by Hurt Notes
		...
		if (choseAttack == true && PlayState.SONG.player1 == 'playablegf' && Paths.formatToSongPath(SONG.song) == 'lustality-remix')
		{
			boyfriend.specialAnim = true;
			//Do nothing else
		}
	...
	function noteMissPress(direction:Int = 1):Void //You pressed a key when there was no notes to press for this key
	{
		...
		if (!boyfriend.stunned)
		{
			...
			if(boyfriend.hasMissAnimations) 
			{
				...
				else if (reloadingGun == true) //This is for Lustality Remix
				{
					boyfriend.specialAnim = true;
					//Do nothing else
				}
	...
	function opponentNoteHit(note:Note):Void
	{
		...
		if(note.noteType == 'Hey!' && dad.animOffsets.exists('hey')) {
			...
			else if (revivingNarrin == true) //For Narrin Only
			{
				char.specialAnim = true;
				//Do nothing else
			}
		...
		if(Paths.formatToSongPath(SONG.song) == 'marcochrome' && note.noteType == 'Hurt Note' && ClientPrefs.optimizationMode == false)
		{
			// No Animation!
		}
		else
	...
	function goodNoteHit(note:Note):Void
	{
		if (!note.wasGoodHit)
		{
			...
			if (!note.isSustainNote)
			{
				...
				if (isMayhemMode && combo > mayhemBestCombo)
					mayhemBestCombo = combo;
				else if (isInjectionMode && combo > injectionBestCombo)
					injectionBestCombo = combo;
				else if (combo > ClientPrefs.campaignBestCombo)
					ClientPrefs.campaignBestCombo = combo;
			...
			else
			{
				if (Paths.formatToSongPath(SONG.song) == 'villainy' || Paths.formatToSongPath(SONG.song) == 'point-blank' || Paths.formatToSongPath(SONG.song) == 'libidinousness'
					|| Paths.formatToSongPath(SONG.song) == 'excrete' || Paths.formatToSongPath(SONG.song) == 'iniquitous' || Paths.formatToSongPath(SONG.song) == 'marauder')
				{
					health += (note.hitHealth - 0.006) * healthGain;
					healthCheck += (note.hitHealth - 0.006) * healthGain;
				}
				else
				{
					health += note.hitHealth * healthGain;
					healthCheck += note.hitHealth * healthGain;
				}
	...
	private function checkForAchievement(achievesToCheck:Array<String> = null):String
	{
		...
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName) && !cpuControlled) {
				...
				{
					//Week Achievements
					case 'Tutorial_Beaten':
						if(WeekData.getWeekFileName() == 'mainTutWeek' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							unlock = true;
							ClientPrefs.eggs += 1;
							ClientPrefs.mainWeekFound = true;

							ClientPrefs.coreMechTutUnlocked = true;
					...
					case 'WeekMarco_Beaten':
						if(WeekData.getWeekFileName() == 'mainweek' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							unlock = true;
							ClientPrefs.eggs += 1;
							ClientPrefs.weeksUnlocked += 1;

							ClientPrefs.mainWeekBeaten = true;
							ClientPrefs.nunWeekFound = true;
							ClientPrefs.shopUnlocked = true;
							ClientPrefs.buff1Unlocked = true;

							ClientPrefs.shopTutUnlocked = true;

							NotificationAlert.sendCategoryNotification = true;
							NotificationAlert.sendInventoryNotification = true;
							NotificationAlert.sendTutorialNotification = true;
							NotificationAlert.sendShopNotification = true;
							NotificationAlert.sendMessage = true;
							
							NotificationAlert.saveNotifications();
							ClientPrefs.saveSettings();
						}
					case 'WeekMarcoVillainous_Beaten':
						if(WeekData.getWeekFileName() == 'mainweek' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice && CoolUtil.difficultyString() == 'VILLAINOUS' )
						{
							unlock = true;
							ClientPrefs.eggs += 1;
					...
					case 'WeekMarcoIniquitous_Beaten':
						if(WeekData.getWeekFileName() == 'mainweek' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && CoolUtil.difficultyString() == 'INIQUITOUS' && !usedPractice)
						{
							unlock = true;
							ClientPrefs.eggs += 1;
					...
					case 'WeekNun_Beaten':
						if(WeekData.getWeekFileName() == 'weekbeatrice' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							...
							ClientPrefs.buff2Unlocked = true;
					...
					case 'WeekKiana_Beaten':
						if(WeekData.getWeekFileName() == 'weekkiana' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							...
							ClientPrefs.eggs += 1;
							ClientPrefs.weeksUnlocked += 1;
							ClientPrefs.buff3Unlocked = true;
					...
					case 'WeekMorky_Beaten':
						if(WeekData.getWeekFileName() == 'weekmorky' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							unlock = true;
					...
					case 'WeekMorkyVillainous_Beaten':
						if(WeekData.getWeekFileName() == 'weekmorky' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && CoolUtil.difficultyString() == 'VILLAINOUS' && !usedPractice)
						{
							unlock = true;
					...
					case 'WeekSus_Beaten':
						if(WeekData.getWeekFileName() == 'weeksussus' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							unlock = true;
					...
					case 'WeekSusVillainous_Beaten':
						if(WeekData.getWeekFileName() == 'weeksussus' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && CoolUtil.difficultyString() == 'VILLAINOUS' && !usedPractice)
						{
							unlock = true;
					...
					case 'WeekLegacy_Beaten':
						if(WeekData.getWeekFileName() == 'weeklegacy' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							unlock = true;
					...
					case 'WeekLegacyVillainous_Beaten':
						if(WeekData.getWeekFileName() == 'weeklegacy' && isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && CoolUtil.difficultyString() == 'VILLAINOUS' && !usedPractice)
						{
							unlock = true;
					...
					//Shop Songs
					case 'short_Beaten':
						if(Paths.formatToSongPath(SONG.song) == 'jerry' && !changedDifficulty && !usedPractice) {
							ClientPrefs.shortPlayed = true;
							ClientPrefs.saveSettings();
						}
					case 'tofu_Beaten':
