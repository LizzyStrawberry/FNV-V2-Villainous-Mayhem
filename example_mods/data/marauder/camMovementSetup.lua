...
function onBeatHit()
	...
	if curBeat == 224 then
		callScript("scripts/Camera Movement", "setCameraProperty", {"dadCamera", "710, 430"})
		callScript("scripts/Camera Movement", "setCameraProperty", {"bfCamera", "710, 430"})
	end
	if curBeat == 160 or curBeat == 352 then
