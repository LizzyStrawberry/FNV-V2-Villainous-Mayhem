...
function createMayhemBar()
	...
	makeLuaSprite('mayhemPads', 'mayhemBar/mayhemPads', mobileFix("X", 450), 550)
	...
	makeLuaSprite('mayhemBar', 'mayhemBar/mayhemBar', mobileFix("X", 450), 550)
	setObjectCamera('mayhemBar', 'hud')
	setObjectOrder('mayhemBar', getObjectOrder('mayhembackBar') + 1)
	addLuaSprite('mayhemBar', true)
		
	makeLuaSprite('mayhemText', 'mayhemBar/mayhemText', mobileFix("X", 450), 550)
