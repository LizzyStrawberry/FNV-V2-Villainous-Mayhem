...
function updateShader()--update shader from slider stored values
	if shadedSong then
		...
		for char = 2, #(spritesToCheck) do
			setShaderFloatArray(spritesToCheck[char], 'overlayColor', getShaderFloatArray('boyfriend', 'overlayColor'))
			setShaderFloatArray(spritesToCheck[char], 'satinColor', getShaderFloatArray('boyfriend', 'satinColor'))
			setShaderFloatArray(spritesToCheck[char], 'innerShadowColor', getShaderFloatArray('boyfriend', 'innerShadowColor'))
			setShaderFloat(spritesToCheck[char], 'innerShadowAngle', getShaderFloat('boyfriend', 'innerShadowAngle'))
			setShaderFloat(spritesToCheck[char], 'innerShadowDistance', getShaderFloat('boyfriend', 'innerShadowDistance'))
		end
	end
end